...
public class GameBoard extends AppCompatActivity implements OnCardFlipListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChanceFactory chanceFactory = new ChanceFactory(lifeAmount,inflater,linearLayout,this);
        List<ImageView> lifeIcons = chanceFactory.printChances();
        // logika gry
        gameLogic = new GameLogic(this::showModal, executor, lifeIcons);
